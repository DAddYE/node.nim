...
proc lthread_create* (new_lt: ref ref LThread, a3: LThreadFunc, arg: pointer): cint
proc lthread_cancel* (lt: ref LThread)
proc lthread_run* ()
proc lthread_join* (lt: ref LThread, p: ref pointer, timeout: uint64): cint
proc lthread_detach* ()
...
proc lthread_current* (): ref LThread
...
when isMainModule:
  ...
  block:
    ...
    proc d (x: pointer){.cdecl.} =
      var lt_new: ref ref LThread = nil; lt_new.new
      lthread_detach()
      echo "d is running"
    ...
    var t: ref ref LThread = nil; t.new
